...
/*        prefManager = new PrefManager(this);
        ...
        finishTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Common.savePref(getApplicationContext(),"swiper",true);
                finish();
            }
        });
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            /*
            if(position == 9){
                Button btn_login = (Button) view.findViewById(R.id.btn_intro_login);
                btn_login.setOnClickListener(new View.OnClickListener() {
        			
        			@Override
        			public void onClick(View arg0) {
        				Intent intent = new Intent();
        				intent.putExtra("btn", "login");
        				setResult(RESULT_OK, intent);
        				finish();
        			}
        		});
                
                Button btn_join = (Button) view.findViewById(R.id.btn_intro_join);
                btn_join.setOnClickListener(new View.OnClickListener() {
        			
        			@Override
        			public void onClick(View arg0) {
        				Intent intent = new Intent();
        				intent.putExtra("btn", "join");
        				setResult(RESULT_OK, intent);
        				finish();
        			}
        		});         	
